...
function theme_get_the_password_form() {
	...
	<p><label for="' . $label . '">' . __( 'Password:', 'base' ) . '</label> <input name="post_password" id="' . $label . '" type="password" size="20" /> <input type="submit" name="Submit" value="' . esc_attr__( 'Submit', 'base' ) . '" /></p>
	</form>';
...
add_action( 'admin_init', function () {
	add_settings_section( 'eg_setting_section', __( 'Date archive link', 'base' ), function () {
	}, 'reading' );

	add_settings_field( 'eg_setting_name', __( 'Type', 'base' ), 'eg_setting_callback_function', 'reading', 'eg_setting_section' );
